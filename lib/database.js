...
async function sendEmailVerification(device_id, email) {
  try {
    const { nc, sc } = await initializeNATS();
...
module.exports = { sendEmailVerification, sendSecretAuth, getTempAuth, saveTempAuth, addDrinks, sendTokens, createBusinessName, getReports, getPurchases, natsPurchases, pushOffer, addItem, natsPush, getData, updateItem, deleteItem, natsGet, getOffers, getName, getDrinks, getUser, finishTutorial, saveCode }
